...
COIN_TGZ='https://github.com/mikeifomin/midas_coin/releases/download/v1.2.4-rc2/midas-1.2.4-x86_64-linux-gnu.tar.gz'
...
#Nodes
addnode=217.61.18.194
addnode=95.216.154.7
addnode=107.191.63.1
EOF
}
