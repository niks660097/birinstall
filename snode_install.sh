...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='snodecoin.conf'
CONFIGFOLDER='/root/.snodecoin'
COIN_DAEMON='snodecoind'
COIN_CLI='snodecoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/snodeco/snode-coin/releases/download/v3.0.1/snodecoin-3.0.1-linux64.tar.gz'
...
function create_key() {
  echo -e "Enter your ${RED}$COIN_NAME Masternode Private Key${NC} that you have generated on the local wallet."
  read -e COINKEY
  if [[ -z "$COINKEY" ]]; then
